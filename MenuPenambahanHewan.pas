...
begin
  try
    ...
    begin
      ...
      ZPenambahanHewan.SQL.Text:='SELECT * FROM penambahan_hewan WHERE id_penambahan LIKE ' + cari + 'or id_wilayah LIKE' + cari + 'or id_hewan LIKE'+ cari + 'or jumlah LIKE'+ cari + 'or ket LIKE' + cari + ' or satuan LIKE' + cari;
